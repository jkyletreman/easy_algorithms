...
describe('Anagrams', function() {
  ...
  describe('groupAnas', function() {
    // it signals the first test, a description followed by the test
    it('should return anagrams grouped by order in array', function() {
    ...
    it('the combined inner arrays length should equal to the original array length', function () {
      const result = groupAnas(testME);
